# python draw-Central.py --task SR_mnist --graph Centralized_n=10_b=0 --partition LabelSeperation --portrait
...
args.task = 'SR_mnist'
args.graph = 'Centralized_n=10_b=0'
...
pic_name = 'centralized_' + task_name + '_' + graph_name + '_' + partition_name + '_without_attack'
