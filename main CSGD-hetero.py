...
from ByrdLab.centraliedAlgorithm import CSGD, CSGD_under_DPA, CSGD_compute_hetero
...
# initilize optimizer
env = CSGD_compute_hetero(aggregation=aggregation, honest_nodes=honest_nodes, byzantine_nodes=byzantine_nodes, attack=attack, step_agg = step_agg,
...
log('[Start Running]')
_, loss_path, acc_path, hetero_list = env.run()
...
if record_in_file:
    ...
    dump_file_in_cache(title + '_hetero_list', hetero_list, path_list=path_list)
print('-------------------------------------------')
